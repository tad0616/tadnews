...
function update_mail(){
    ...
    redirect_header(XOOPS_URL,3, sprintf(_MA_TADNEWS_ERROR_EMAIL,$_POST['newspaper_email']));
    return;
	}
    ...
    $now=date("Y-m-d H:i:s",xoops_getUserTimestamp(time()));
		...
		$xoopsDB->query($sql) or redirect_header(XOOPS_URL,3, sprintf(_MA_TADNEWS_ORDER_ERROR,$newspaper_set['title']));
	  redirect_header(XOOPS_URL,3, sprintf(_MA_TADNEWS_ORDER_SUCCESS,$newspaper_set['title']));
