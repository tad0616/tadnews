...
define("_MA_TADNEWS_NEWS_PIC","上傳文章封面圖");
define("_MA_TADNEWS_ORDER_SUCCESS","訂閱「%s」完成！");
define("_MA_TADNEWS_ORDER_ERROR","訂閱「%s」失敗！");
define("_TADNEWS_DEL_SUCCESS","取消訂閱「%s」完成！");
define("_TADNEWS_DEL_ERROR","取消訂閱「%s」失敗！");
define("_MA_TADNEWS_NP_TITLE","第 %s 期");
define("_MA_TADNEWS_FILE_DL_NUM","（已被下載 %s 次）");
define("_MA_TADNEWS_ERROR_EMAIL","%s 不是合法的Email");
...
define("_MA_TADNEWS_ADD_NEWS","編輯文章");
...
define("_MA_TADNEWS_NEWS_CATE","文章分類");
define("_MA_TADNEWS_SELECT_NEWS_CATE","請選擇文章分類");
...
define("_MA_TADNEWS_NEWS_ENABLE_OK","公開");
...
define("_MA_TADNEWS_CREAT_FIRST_CATE","建立新分類");
...
define("_MB_TADNEWS_ALWAYS_TOP","置頂文章");
define("_MD_TADNEWS_ALWAYS_TOP","今日文章");



define("_MB_TADNEWS_TIME_TAB","發布時間");
define("_MB_TADNEWS_PRIVILEGE_TAB","權限");
define("_MB_TADNEWS_NEWSPIC_TAB","封面圖");
define("_MB_TADNEWS_FILES_TAB","附檔");
define("_MB_TADNEWS_ENABLE_NEWSPIC","是否顯示");
define("_MB_TADNEWS_ENABLE_NEWSPIC_NO","不要在內文中顯示封面圖");
define("_MB_TADNEWS_ENABLE_NEWSPIC_YES","要在內文中顯示封面圖（當作插圖用）");
define("_MB_TADNEWS_NEWSPIC_SIZE","圖片框尺寸");
define("_MB_TADNEWS_NEWSPIC_WIDTH","寬 x 高");
define("_MB_TADNEWS_NEWSPIC_BORDER","圖片邊框外觀");
define("_MB_TADNEWS_NEWSPIC_BORDER_WIDTH","粗細");
define("_MB_TADNEWS_NEWSPIC_BORDER_STYTLE","線條");
define("_MB_TADNEWS_NEWSPIC_SOLID","實線");
define("_MB_TADNEWS_NEWSPIC_DASHED","虛線");
define("_MB_TADNEWS_NEWSPIC_DOUBLE","雙線");
define("_MB_TADNEWS_NEWSPIC_DOTTED","點線");
define("_MB_TADNEWS_NEWSPIC_GROOVE","凹線");
define("_MB_TADNEWS_NEWSPIC_RIDGE","凸線");
define("_MB_TADNEWS_NEWSPIC_INSET","嵌入線");
define("_MB_TADNEWS_NEWSPIC_OUTSET","浮出線");
define("_MB_TADNEWS_NEWSPIC_NONE","無框線");
define("_MB_TADNEWS_NEWSPIC_BORDER_COLOR","顏色");
define("_MB_TADNEWS_NEWSPIC_FLOAT","圖片框位置");
define("_MB_TADNEWS_NEWSPIC_FLOAT_LEFT","靠左文繞圖");
define("_MB_TADNEWS_NEWSPIC_FLOAT_RIGHT","靠右文繞圖");
define("_MB_TADNEWS_NEWSPIC_FLOAT_NONE","不文繞圖");
define("_MB_TADNEWS_NEWSPIC_MARGIN","外邊界");
define("_MB_TADNEWS_NEWSPIC","封面圖的重複方式");
define("_MB_TADNEWS_NEWSPIC_NO_REPEAT","不重複");
define("_MB_TADNEWS_NEWSPIC_REPEAT","重複");
define("_MB_TADNEWS_NEWSPIC_X_REPEAT","水平重複");
define("_MB_TADNEWS_NEWSPIC_Y_REPEAT","垂直重複");
define("_MB_TADNEWS_NEWSPIC_SHOW","呈現封面圖的");
define("_MB_TADNEWS_NEWSPIC_AND","縮放封面圖");
define("_MB_TADNEWS_NEWSPIC_LEFT_TOP","左上");
define("_MB_TADNEWS_NEWSPIC_LEFT_CENTER","左中");
define("_MB_TADNEWS_NEWSPIC_LEFT_BOTTOM","左下");
define("_MB_TADNEWS_NEWSPIC_RIGHT_TOP","右上");
define("_MB_TADNEWS_NEWSPIC_RIGHT_CENTER","右中");
define("_MB_TADNEWS_NEWSPIC_RIGHT_BOTTOM","右下");
define("_MB_TADNEWS_NEWSPIC_CENTER_TOP","中上");
define("_MB_TADNEWS_NEWSPIC_CENTER_CENTER","中中");
define("_MB_TADNEWS_NEWSPIC_CENTER_BOTTOM","中下");
define("_MB_TADNEWS_NEWSPIC_NO_RESIZE","不做任何縮放");
define("_MB_TADNEWS_NEWSPIC_CONTAIN","縮放以看見完整封面圖");
define("_MB_TADNEWS_NEWSPIC_COVER","縮放到塞滿整個圖片框長邊");
define("_MB_TADNEWS_NEWSPIC_DEMO","<p>所謂「封面圖」指的就是替每一篇文章上傳一個具有代表性的圖片，此圖片會用在各個區塊上，以增加版面的活潑性。每個區塊的封面圖都可以自行去設定其大小及外觀。若是您想把封面圖也放到內文中當作插圖，那麼，您可以利用此界面來做設定。</p>
           <p>封面圖並沒有一定要多大，但由於封面圖也可以用在滑動新聞區塊上作為大張的滑動圖，因此建議您，圖的大小至少比滑動區塊大即可，預設值為 670x250，因此，建議您，封面圖盡量在這個大小範圍為佳。</p>");

//define("_MD_TADNEWS_EMBED","嵌入語法");

define("_MB_TADNEWS_TABLE_CONTENT_WIDTH","呈現寬度");
define("_MB_TADNEWS_MORE","觀看完整文章");
define("_MB_TADNEWS_DEL_FILE","選擇要刪除的檔案：");
?>
