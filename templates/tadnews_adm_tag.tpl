        ...
        <{foreach item=tag from=$tagarr}>
            ...
            <{else}>
                <tr>
                    ...
                    <td>
                        <a href='tag.php?tag_sn=<{$tag.tag_sn}>' class='btn btn-sm btn-xs btn-info'><{$smarty.const._TADNEWS_EDIT}></a>
                        <{if $tag.enable}>
                        ...
                        <{if !$tag.enable and $tag.tag_amount == 0}>
                            <a href='javascript:delete_tag(<{$tag.tag_sn}>);' class='btn btn-sm btn-xs btn-danger'><{$smarty.const._TADNEWS_DEL}></a>
                        <{/if}>
                    </td>
                </tr>
            <{/if}>
