        ...
        <{foreach item=log from=$log }>
          <{if !$i}><tr><{/if}>
            ...
            <{else}>
              ...
              <td>
                <a href="newspaper.php?op=newspaper_email&nps_sn=<{$nps_sn}>&memail=<{$log.email}>&g2p=<{$g2p}>" class="btn btn-xs btn-warning"><{$smarty.const._TADNEWS_EDIT}></a>
                <a href="javascript:delete_tad_news_email_func('<{$log.email}>');" class="btn btn-xs btn-danger"><{$smarty.const._TADNEWS_DEL}></a>
              </td>
              <td>
                <{$log.data}>
              </td>
      ...
      <table class="table table-striped table-hover">
        ...
        <{foreach item=np from=$newspaper}>
          <tr>
            ...
            <td><{$np.np_date}></td>
            <td>
              <a href="newspaper.php?op=edit_newspaper&npsn=<{$np.allnpsn}>" class="btn btn-xs btn-warning"><{$smarty.const._TADNEWS_EDIT}></a>
              <a href="javascript:delete_tad_newspaper(<{$np.allnpsn}>);" class="btn btn-xs btn-danger"><{$smarty.const._TADNEWS_DEL}></a>
              <a href="newspaper.php?op=sendmail_log&npsn=<{$np.allnpsn}>" class="btn btn-xs btn-info"><{$smarty.const._MA_TADNEWS_SEND_LOG}></a>
              <a href="newspaper.php?op=sendmail&npsn=<{$np.allnpsn}>" class="btn btn-xs btn-primary"><{$smarty.const._MA_TADNEWS_SEND_NOW}></a>
            </td>
          </tr>
        <{/foreach}>
      </table>
