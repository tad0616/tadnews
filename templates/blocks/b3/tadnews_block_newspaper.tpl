...
<{$block.counter}>
    <form action="<{$xoops_url}>/modules/tadnews/email.php" method="post">
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label" for="newspaper"><{$smarty.const._MB_TADNEWS_TITLE}></label>
            <div class="col-sm-8">
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label" for="newspaper_email"><{$smarty.const._MB_TADNEWS_EMAIL}></label>
            <div class="col-sm-8">
