            ...
            <div class="row" style="margin-bottom: 0.6rem;">
                <div class="col-lg-<{$block.width_left}>">
                    <a href="<{$xoops_url}>/modules/tadnews/index.php?nsn=<{$news.nsn}>">
                        <div style="height:<{$block.height}>;overflow:hidden;border:1px solid gray;background-image: url('<{if $news.image_big}><{$news.image_big}><{else}><{$xoops_url}>/modules/tadnews/images/demo<{$i}>.jpg<{/if}>'); background-size: cover;background-position: center center; color: transparent;"><{$news.news_title}>
                        </div>
                    </a>
                </div>
