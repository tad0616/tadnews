    ...
    <tbody>
      <{foreach item=page from=$page}>
        <tr>
          ...
          <td>
            <a href="javascript:delete_tad_news_func(<{$page.nsn}>);" class='btn btn-danger btn-sm btn-xs'><{$smarty.const._TAD_DEL}></a>
            <a href="post.php?op=tad_news_form&nsn=<{$page.nsn}>" class="btn btn-warning btn-sm btn-xs"><{$smarty.const._TAD_EDIT}></a>
            <{if $page.enable!='1'}>
