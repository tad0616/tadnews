            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="setup[only_title]" id="only_title_1" value="1" <{if $only_title=='1'}>checked<{/if}>>
                  <label class="form-check-label" for="only_title_1"><{$smarty.const._MA_TADNEWS_DISPLAY_TITLE}></label>
                </div>

                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="setup[only_title]" id="only_title_0" value="0" <{if $only_title!='1'}>checked<{/if}>>
                  <label class="form-check-label" for="only_title_0"><{$smarty.const._MA_TADNEWS_HIDE_ARTICLE}></label>
                </div>
              </div>
            </div>
          </div>
              ...
              <{foreach item=page from=$page}>
                <tr>
                  ...
                  <td>
                    ...
                    <span style="color:gray;font-size: 0.75em;"> (<a href="main.php?show_uid=<{$page.uid}>"><{$page.uid_name}></a> / <{$page.counter}>)</span> <{$page.passwd}>
                  </td>
