<form action="page.php" method="post" id="myForm" enctype="multipart/form-data" role="form">
    ...
    <div class="card card-body m-1" style="background-color:#EEFFCC;">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="setup[breadcrumbs]" id="setup_breadcrumbs_1" value="1" <{if $breadcrumbs=='1'}>checked<{/if}>>
                <label class="form-check-label" for="setup_breadcrumbs_1"><{$smarty.const._YES}></label>
                </div>
                <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="setup[breadcrumbs]" id="setup_breadcrumbs_0" value="0" <{if $breadcrumbs!='1'}>checked<{/if}>>
                <label class="form-check-label" for="setup_breadcrumbs_0"><{$smarty.const._NO}></label>
                </div>
            </div>
