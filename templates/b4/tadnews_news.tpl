        ...
        <div class="col-sm-12">
          <div <{if $page.need_sign}>style="background-image: url('<{$page.need_sign}>'); background-position: right top; background-repeat: no-repeat;"<{/if}>>
            <h2 style="padding:10px 0px;">
              <a href="<{$xoops_url}>/modules/tadnews/index.php?nsn=<{$page.nsn}>" style="font-size: 1.5em;  font-weight: normal; line-height: 150%;">
              <{$page.news_title}>
              </a>
            </h2>
          </div>
      ...
      <div class="row">
        <div class="col-sm-6">
          <{if $page.back_news_link}>
            <a href="<{$page.back_news_link}>" class="btn btn-outline-info btn-block">
        ...
        <div class="col-sm-6">
          <{if $page.next_news_link}>
            <a href="<{$page.next_news_link}>" class="btn btn-outline-info btn-block"><{$page.next_news_title}><img src="images/right.png" hspace=2 alt="<{$page.next_news_title}>" title="<{$page.next_news_title}>"></a>
          <{/if}>
        </div>
      </div>
