...
<form action="page.php" method="post" id="myForm" enctype="multipart/form-data" class="form-horizontal" role="form">
    ...
    <div class="text-center">
        ...
        <{$XOOPS_TOKEN|default:''}>
        <button type="submit" class="btn btn-info"><{if $ncsn==""}><{$smarty.const._MD_TADNEWS_ADD_CATE}><{else}><i class="fa fa-floppy-disk" aria-hidden="true"></i>  <{$smarty.const._TAD_SAVE}><{/if}></button>
    </div>
</form>