...
$modversion['version']     = $_SESSION['xoops_version'] >= 20511 ? '5.2-Stable' : '5.02';
...
//---模組狀態資訊---//
$modversion['release_date']        = '2026-09-08';
...
$modversion['config'] = [
    ...
    ['name' => 'uid_chk', 'title' => '_MI_UPDATE_UID_CHK', 'description' => '_MI_UPDATE_UID_CHK_DESC', 'formtype' => 'yesno', 'valuetype' => 'int', 'default' => 1],
];
