    ...
    public function get_news($mode = 'assign', $admin = false)
    {
        ...
        while (false !== ($news = $xoopsDB->fetchArray($result))) {
            ...
            if (!empty($this->summary_num) and is_numeric($this->summary_num)) {
                ...
                $more = mb_strlen($news_content) <= $this->summary_num ? '' : "... <a href='" . XOOPS_URL . "/modules/tadnews/index.php?ncsn={$ncsn}&nsn={$nsn}' style='font-size: 0.75em;'><i class=\"fa fa-file-text-o\"></i>" . _TADNEWS_MORE . '</a>';
                ...
                $more = (empty($content_arr[1])) ? '' : "<p><a href='" . XOOPS_URL . "/modules/tadnews/index.php?ncsn={$ncsn}&nsn={$nsn}' style='font-size: 0.75em;'>" . _TADNEWS_MORE . '...</a></p>';
                ...
                $more = (empty($content[1])) ? '' : "<p><a href='" . XOOPS_URL . "/modules/tadnews/index.php?ncsn={$ncsn}&nsn={$nsn}' style='font-size: 0.75em;'>" . _TADNEWS_MORE . '...</a></p>';
